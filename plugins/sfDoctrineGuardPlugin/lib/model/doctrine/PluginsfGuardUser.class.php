...
abstract class PluginsfGuardUser extends BasesfGuardUser
{
  ...
  public function setPassword($password)
  {
    ...
    //var_dump($modified); echo "<br>"; die($this->getTable()->getDefaultValueOf('algorithm'));
    ...
    $this->_set('password', call_user_func_array($algorithm, array($password.$salt)));
  }
  ...
  public function checkPasswordByGuard($password)
  {
    ...
    return $this->getPassword() == call_user_func_array($algorithm, $algorithm1 == "user::generate_password" ? array($password.$this->getSalt()):array($this->getSalt().$password));
  }
