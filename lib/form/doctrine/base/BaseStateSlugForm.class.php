...
/**
 * StateSlug form base class.
 *
 * @method StateSlug getObject() Returns the current form's model object
 *
 * @package    realstate
 * @subpackage form
 ...
 */
abstract class BaseStateSlugForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('state_slug[%s]');
