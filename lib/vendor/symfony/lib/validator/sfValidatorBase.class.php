...
abstract class sfValidatorBase
{
  protected static
    $charset = 'UTF-8',
    $globalDefaultMessages = array('invalid' => 'Invalid.', 'required' => 'Required.','not_activated' => 'Not Activated.');
  ...
  public function __construct($options = array(), $messages = array())
  {
    ...
    $this->messages = array_merge(array('required' => self::$globalDefaultMessages['required'], 'invalid' => self::$globalDefaultMessages['invalid'],'not_activated' => self::$globalDefaultMessages['not_activated'] ), $this->messages);
